...
export const validateDescription = (description: string): boolean | string => {
...
// Validates released
export const validateReleased = (released: string) : boolean | string => {
...
// Validates rating
export const validateRating = (rating: number) : boolean | string => {
